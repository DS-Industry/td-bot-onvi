...
class TelegramBot extends EventEmitter {
  ...
  */
   ...
   * @see https://core.telegram.org/bots/api#sendmessage
   */
  sendMessage(chatId, text, topicId = null, form = {}) {
    form.chat_id = chatId;
    form.text = text;

    if (topicId !== null) {
      form.message_thread_id = topicId;
    }
   ...
   * @see https://github.com/yagop/node-telegram-bot-api/blob/master/doc/usage.md#sending-files
   */
  sendPhoto(chatId, photo, options = {}, topicId = null, fileOptions = {}) {
    const opts = {
      qs: options,
    };
    opts.qs.chat_id = chatId;
    if (topicId !== null) {
      opts.qs.message_thread_id = topicId;
    }
    try {
  ...
  * @see https://github.com/yagop/node-telegram-bot-api/blob/master/doc/usage.md#sending-files
  */
  sendDocument(chatId, doc, options = {}, topicId = null, fileOptions = {}) {
    const opts = {
      qs: options
    };
    opts.qs.chat_id = chatId;
   ...
   * @see https://github.com/yagop/node-telegram-bot-api/blob/master/doc/usage.md#sending-files
   */
  sendVideo(chatId, video, options = {}, topicId = null, fileOptions = {}) {
    const opts = {
      qs: options
    };
    opts.qs.chat_id = chatId;
  ...
  */
   ...
   */
  sendSticker(chatId, sticker, topicId = null, options = {}, fileOptions = {}) {
    const opts = {
      qs: options
    };
    opts.qs.chat_id = chatId;
